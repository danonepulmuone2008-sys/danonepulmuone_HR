  ...
  useEffect(() => {
    (async () => {
      const { data: trip } = await supabase
        ...
        .select("id, destination, start_date, end_date, start_time, end_time, lunch_break, reason, status, reviewed_by, reviewed_at, created_at")
        .eq("id", id)
        .single();
      ...
      setData({ ...trip, lunch_break: trip.lunch_break ?? false, reviewed_at: trip.reviewed_at ?? null, created_at: trip.created_at, reviewer_name });
      setLoading(false);
    })();
  }, [id]);
